...
const ourtext = `7.	1 †_‡K 20 Gi g‡a¨ †Rvo †gŠwjK msL¨v KZwU?
K 3wU	L 2wU	 1wU	N GKwUI bq
8.	1, 4,16 .... c¨vUvb©wUi lô msL¨vwU KZ? 
K 84	L 112	M 256	 1024
`

// const ourtext = `6.	wb‡Pi †KvbwU c¨vUv‡b© mvRv‡bv?	(ga¨g)
// K 1, 2, 4, 6, ...	L 2, 4, 5, 6, ...
//  1, 3, 5, 7, ...	N 2, 3, 6, 9, ...
// `
console.log(ConvertToUnicode('bijoy',ConvertToASCII('bijoy',ourtext)))